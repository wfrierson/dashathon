...
class MergeingMethodsTest(unittest.TestCase):
    ...
    def test_transform_llimllib_boston_data(self):
        test_llimllib = pd.read_csv('dashathon/data/external_data/llimllib_boston_results_2013.csv', delimiter=',', nrows=1)
    ...
    def test_convert_string_to_seconds(self):
        assert merge.convert_string_to_seconds('00:41:41') == 2501


    def test_transform_rojour_boston_data(self):
        test_rojour = pd.read_csv('dashathon/data/external_data/rojour_boston_results_2015.csv', delimiter=',', nrows=1)
    ...
    def test_append_age_banding(self):
    ...
    def test_combine_boston_data(self):
        test_llimllib = pd.read_csv('dashathon/data/external_data/llimllib_boston_results_2013.csv', delimiter=',', nrows=1)
        test_transformed_llimllib = merge.transform_llimllib_boston_data(test_llimllib, 2013)
        test_rojour = pd.read_csv('dashathon/data/external_data/rojour_boston_results_2015.csv', delimiter=',', nrows=1)
        test_transformed_rojour = merge.transform_rojour_boston_data(test_rojour, 2015)
    ...
    def test_pipe_reader(self):
        assert merge.pipe_reader('dashathon/data/scraped_data/chicago_marathon_2017_M.csv').shape == (22824, 20)


    def test_process_boston_data(self):
        assert merge.process_boston_data().shape == (127545, 26)


    def test_process_nyc_data(self):
        assert merge.process_nyc_data().shape == (200288, 27)


    def test_process_chicago_data(self):
    ...
    def test_process_berlin_data(self):
